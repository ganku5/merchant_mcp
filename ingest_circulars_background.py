...
CIRCULARS = [
    ("/home/ganesh/Downloads/RMD 001 to prevent  misleading VPA creation_260620.pdf", "rmd_001_vpa_creation"),
    ("/home/ganesh/Downloads/UPI+OC+141-Safeguarding+Users+on+UPI+(1).pdf", "upi_oc_141_safeguard_users"),
    ("/home/ganesh/Downloads/UPI_Error_and_Response_Codes_2_9.pdf", "upi_error_response_codes"),
    ("/home/ganesh/Downloads/TSD_IBMB_1.5.pdf", "tsd_ibmb_1_5"),
    ("/home/ganesh/Downloads/TSD -AutoPay Interoperability V1.5.pdf", "tsd_autopay_interoperability"),
    ("/home/ganesh/Downloads/Multi-Signatory Accounts on UPI TSD v.1.4.pdf", "tsd_multi_signatory_accounts"),
    ("/home/ganesh/Downloads/Contextual_Payments_V1.1_TSD.pdf", "contextual_payments_tsd"),
]
...
async def ingest_all():
    ...
    for filepath, doc_id in CIRCULARS:
        if not os.path.exists(filepath):
            ...
            results.append({"doc_id": doc_id, "status": "missing", "error": "File not found"})
            continue
