            ...
            "error_responses": [
                {
                    ...
                    "http_status": 400,
                    "description": "Merchant ID is invalid or inactive",
                },
                {
        ...
        },
        {
            ...
            "request_schema": {
                "fields": [
                    ...
                    },
                    {
                        ...
                        "field_type": "number",
                        "required": False,
                        "description": "Amount to refund (omit for full)",
                    },
                    {
            ...
            "error_responses": [
                ...
                },
                {
                    ...
                    "http_status": 400,
                    "description": "Merchant settlement balance insufficient",
                },
            ],
            "spec_data": {},
            "is_ground_truth": False,
