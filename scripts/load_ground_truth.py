...
GROUND_TRUTH_FIXTURES = [
    str(PROJECT_ROOT / "tests/fixtures/ground_truth/orders_create_full.json"),
    str(PROJECT_ROOT / "tests/fixtures/ground_truth/order_status_full.json"),
    str(PROJECT_ROOT / "tests/fixtures/ground_truth/refund_create_full.json"),
    str(PROJECT_ROOT / "tests/fixtures/ground_truth/error_codes_full.json"),
]
