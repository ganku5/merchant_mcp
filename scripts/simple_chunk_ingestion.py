...
async def simple_ingest():
    ...
    async with database.pool.acquire() as conn:
        ...
        doc = await conn.fetchrow("SELECT doc_id, content FROM documents WHERE doc_id = 'ibmb_axis_api_specs'")
        ...
        for i, page in enumerate(pages):
            ...
            await conn.execute("""
                ...
                VALUES ($1, $2, $3, $4, $5)
            """, doc['doc_id'], i, chunk_text, None, 'pdf_ibmb')
        ...
        # Show stats
        total = await conn.fetchval("SELECT COUNT(*) FROM text_chunks WHERE doc_id = $1", doc['doc_id'])
